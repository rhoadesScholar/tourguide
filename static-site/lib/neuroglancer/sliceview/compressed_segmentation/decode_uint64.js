 ...
 */
export function readSingleChannelValue(out, data, baseOffset, chunkDataSize, blockSize, dataPosition) {
    var outputValueOffset = decodeValueOffset(data, baseOffset, chunkDataSize, blockSize, dataPosition, 2) + baseOffset;
 ...
 */
export function readValue(out, data, baseOffset, chunkDataSize, blockSize, dataPosition) {
...
//# sourceMappingURL=decode_uint64.js.map