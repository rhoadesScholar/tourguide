...
export function disableContextMenu() {
    return registerEventListener(document, 'contextmenu', function (e) {
        e.preventDefault();
    });
}
export function disableWheel() {
    return registerEventListener(document, 'wheel', function (e) {
        if (e.ctrlKey) {
            e.preventDefault();
        }
    });
}
//# sourceMappingURL=disable_default_actions.js.map