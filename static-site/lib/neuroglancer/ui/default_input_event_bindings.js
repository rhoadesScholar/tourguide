...
var defaultGlobalBindings = void 0;
...
var defaultRenderedDataPanelBindings = void 0;
export function getDefaultRenderedDataPanelBindings() {
    if (defaultRenderedDataPanelBindings === undefined) {
        defaultRenderedDataPanelBindings = EventActionMap.fromObject({
            ...
            'at:shift+mouseup0': 'select-annotation',
...
var defaultPerspectivePanelBindings = void 0;
...
var defaultSliceViewPanelBindings = void 0;
...
export function setDefaultInputEventBindings(inputEventBindings) {
...
//# sourceMappingURL=default_input_event_bindings.js.map