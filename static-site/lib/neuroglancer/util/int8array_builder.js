 ...
 */
export var Int8ArrayBuilder = function () {
    function Int8ArrayBuilder() {
        var initialCapacity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 16;

        _classCallCheck(this, Int8ArrayBuilder);

        this.length = 0;
        this.data = new Int8Array(initialCapacity);
    }

    _createClass(Int8ArrayBuilder, [{
        key: "resize",
        value: function resize(newLength) {
            var data = this.data;

            if (newLength > data.length) {
                var newData = new Int8Array(Math.max(newLength, data.length * 2));
...
//# sourceMappingURL=int8array_builder.js.map