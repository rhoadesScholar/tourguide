 ...
 */
import { cancellableFetchOk, getByteRangeHeader, responseArrayBuffer } from './http_request';
/**
...
export function fetchHttpByteRange(url, startOffset, endOffset, cancellationToken) {
  return cancellableFetchOk(url, {
    headers: getByteRangeHeader(startOffset, endOffset),
    cache: cacheMode
  }, responseArrayBuffer, cancellationToken);
}
//# sourceMappingURL=byte_range_http_requests.js.map