 ...
 */
export var Float32ArrayBuilder = function () {
    function Float32ArrayBuilder() {
        var initialCapacity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 16;

        _classCallCheck(this, Float32ArrayBuilder);

        this.length = 0;
        this.data = new Float32Array(initialCapacity);
    }

    _createClass(Float32ArrayBuilder, [{
        key: "resize",
...
//# sourceMappingURL=float32array_builder.js.map