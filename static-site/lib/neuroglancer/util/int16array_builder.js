 ...
 */
export var Int16ArrayBuilder = function () {
    function Int16ArrayBuilder() {
        var initialCapacity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 16;

        _classCallCheck(this, Int16ArrayBuilder);

        this.length = 0;
        this.data = new Int16Array(initialCapacity);
    }

    _createClass(Int16ArrayBuilder, [{
        key: "resize",
        value: function resize(newLength) {
            var data = this.data;

            if (newLength > data.length) {
                var newData = new Int16Array(Math.max(newLength, data.length * 2));
...
//# sourceMappingURL=int16array_builder.js.map