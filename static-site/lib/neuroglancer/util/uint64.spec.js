...
describe('uint64', function () {
    ...
    it('conversion to string', function () {
    ...
    it('conversion from string', function () {
    ...
    it('equal', function () {
        var a = new Uint64(1, 2);
        var b = new Uint64(1, 2);
    ...
    it('parseString failures', function () {
        var temp = new Uint64(1, 2);
    ...
    it('parseString toString round trip', function () {
        function check(s, base) {
            var x = Uint64.parseString(s, base);
    ...
    it('toString parseString round trip', function () {
        function check(x, base) {
            var s = x.toString(base);
            var y = Uint64.parseString(s, base);
        ...
        var count = 100;
        {
            var u = new Uint64(264762631, 2836123747);
