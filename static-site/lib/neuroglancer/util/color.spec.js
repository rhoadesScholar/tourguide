 ...
 */
import { parseColorSerialization, parseRGBColorSpecification, packColor, serializeColor } from './color';
import { vec3, vec4 } from './geom';
describe('color', function () {
    it('parseColorSerialization works', function () {
    ...
    it('serializeColor works', function () {
        expect(serializeColor(vec3.fromValues(0x12 / 255, 0x34 / 255, 0x56 / 255))).toEqual('#123456');
        expect(serializeColor(vec4.fromValues(101 / 255, 102 / 255, 103 / 255, 0.45))).toEqual('rgba(101, 102, 103, 0.45)');
    });
    it('parseRGBColorSpecification works', function () {
