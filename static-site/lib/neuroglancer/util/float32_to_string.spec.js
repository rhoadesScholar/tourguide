...
describe('float32_to_minimal_string', function () {
    it('valid_float_to_minimal_string', function () {
        var val = void 0;
    ...
    it('float32_to_minimal_string_roundtrip', function () {
        var test_values = [0.2999998927116394, 0.2999999225139618, 0.30000001192092896, 0.30000004172325134, 0.0005000000237487257, 0.0005000000819563866, 4.999999987376214e-7, NaN, -Infinity];
        test_values.forEach(function (original) {
            var roundtrip = parseFloat(float32ToString(original));
            expect(_Math$fround(roundtrip)).toEqual(original);
        });
    });
});
//# sourceMappingURL=float32_to_string.spec.js.map