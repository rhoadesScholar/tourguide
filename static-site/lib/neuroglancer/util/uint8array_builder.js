 ...
 */
export var Uint8ArrayBuilder = function () {
    function Uint8ArrayBuilder() {
        var initialCapacity = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 16;

        _classCallCheck(this, Uint8ArrayBuilder);

        this.length = 0;
        this.data = new Uint8Array(initialCapacity);
    }

    _createClass(Uint8ArrayBuilder, [{
        key: "resize",
        value: function resize(newLength) {
            var data = this.data;

            if (newLength > data.length) {
                var newData = new Uint8Array(Math.max(newLength, data.length * 2));
        ...
        value: function shrinkToFit() {
            this.data = new Uint8Array(this.view);
        }
    }, {
        key: "clear",
        ...
        get: function get() {
            ...
            return new Uint8Array(data.buffer, data.byteOffset, this.length);
        }
    }]);

    return Uint8ArrayBuilder;
}();
//# sourceMappingURL=uint8array_builder.js.map