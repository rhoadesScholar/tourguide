 ...
 * filtering, clamping.
 */
export function setRawTextureParameters(gl) {
...
export function setRawTexture3DParameters(gl) {
...
export function resizeTexture(gl, texture, width, height) {
    var internalFormat = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : WebGL2RenderingContext.RGBA8;
    var format = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : WebGL2RenderingContext.RGBA;
    var dataType = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : WebGL2RenderingContext.UNSIGNED_BYTE;
...
export function setTextureFromCanvas(gl, texture, canvas) {
    gl.activeTexture(WebGL2RenderingContext.TEXTURE0 + gl.tempTextureUnit);
    gl.bindTexture(WebGL2RenderingContext.TEXTURE_2D, texture);
